  ...
  const features = [
    {
      ...
      imageAlign: "left",
      visual: (
        <div className="group w-full h-full min-h-[300px] md:min-h-[450px] rounded-3xl border border-white/10 relative overflow-hidden flex items-center justify-center shadow-[0_0_40px_rgba(255,255,255,0.03)] hover:shadow-[0_0_60px_rgba(255,255,255,0.08)] transition-shadow duration-700">
          <video
            autoPlay
            loop
            muted
          ...
          >
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <p className="uppercase tracking-widest text-white/60 text-xs font-semibold">
                  {feature.subtitle}
                </p>
              </div>
              <h3 className="text-3xl md:text-4xl lg:text-5xl text-white tracking-tight font-medium mb-5">
                {feature.title}
              </h3>
